...
public class home_stepdef {
	...
	common_utils objUtils = new common_utils();
	...
	public void user_will_be_redirected_to_homepage() {
		...
		try {			
			...
			objUtils.takeSnapShot(driver, "./target/Screenshot/test_" + now.get(Calendar.HOUR_OF_DAY) + "_" + now.get(Calendar.MINUTE) + "_" +now.get(Calendar.SECOND) + ".png");
		} catch (Exception e) {
