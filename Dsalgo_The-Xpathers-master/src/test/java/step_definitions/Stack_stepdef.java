...
public class Stack_stepdef {
	...
	public void the_user_selects_the_stack_option_from_the_dropdown_menu_or_clicks_on_get_started_button_under_stack()
	...
	public void the_user_enter_the_valid_python_code_in_tryeditor_page_and_click_on_run_button()
			throws InterruptedException {
	...
	public void the_user_is_in_editor_page_and_navigates_to_the_stack_page_for_implementation_page()
			throws InterruptedException {
	...
	public void the_user_should_be_redirected_to_page_having_an_try_editor_with_a_run_button_and_enter_valid_python_code_for_implementation_page()
			throws InterruptedException {
	...
	public void the_user_enter_the_invalid_python_code_in_tryeditor_page_and_click_run_button_for_implementation_page()
			throws InterruptedException {
	...
	public void the_user_is_in_tryeditor_page_and_navigates_to_stack_page_for_application_page()
			throws InterruptedException {
	...
	public void the_user_should_be_redirected_to_page_having_an_try_editor_with_a_run_button_and_enter_python_code_for_applications_page()
			throws InterruptedException {
	...
	public void the_user_enter_the_invalid_python_code_in_tryeditor_and_clickon_run_button_for_applications_page()
			throws InterruptedException {
	...
	public void the_user_will_get_an_error_message_for_applications_page() throws InterruptedException {
		...
		String actualMsg = ObjStackPage.getErrorText();
		LOGGER.info("Error message for invalid python code is" + actualMsg);
		// assertEquals(actualMsg,"SyntaxError: bad input on line 1", "Result do not
		// match");
		// assertEquals(actualMsg,"SyntaxError: bad input on line 1", "Result match");
		assertEquals(actualMsg, "NameError: name 'hello' is not defined on line 1", "Result not matched");
	}
